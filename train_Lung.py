...
parser.add_argument('--n_epochs_tafter', type=int, default='220')
...
testset = torchvision.datasets.ImageFolder(root='D:\LungImages\\trainvaltest\\test/', transform=transform_test)
...
#                               shuffle=True,
#                               batch_size=bs)
train_after_dataset = torchvision.datasets.ImageFolder(root='D:\LungImages\\trainvaltest\\train', transform=transform)
# testloader = torch.utils.data.DataLoader(testset, batch_size=32, shuffle=False, num_workers=0)

for i in range(1):
    temp = torchvision.datasets.ImageFolder(root='D:\LungImages\\trainvaltest\\train', transform=transform)
