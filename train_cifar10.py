...
# testset = torchvision.datasets.ImageFolder(root='./data/CIFAR100/test', transform=transform_test)
...
folder_dataset = torchvision.datasets.CIFAR10(root='./data', train=True, download=True, transform=transform)
...
train_after_dataset = torchvision.datasets.CIFAR10(root='./data', train=True, download=True, transform=transform)
for i in range(1):
    temp = torchvision.datasets.CIFAR10(root='./data', train=True, download=True, transform=transform)
...
# temppr = torch.load('model4cifarnores.pth')
